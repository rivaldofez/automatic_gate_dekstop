...
class UIFunctions(MainWindow):
    ...
    def maximize_restore(self):
        ...
        if status == 0:
            ...
            self.ui.frame_top_btns.setStyleSheet("background-color: rgb(2, 55, 69);")
    ...
    def selectMenu(getStyle):
        select = getStyle + ("QPushButton { border-right: 7px solid  rgb(188, 188, 188); }")
        return select

    ## ==> DESELECT
    def deselectMenu(getStyle):
        deselect = getStyle.replace("QPushButton { border-right: 7px solid  rgb(188, 188, 188); }", "")
        return deselect
